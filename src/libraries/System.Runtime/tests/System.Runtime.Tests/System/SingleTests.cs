...
namespace System.Tests
{
    public class SingleTests
    {
        ...
        [InlineData(0.000244140625f, "0.00024414063")]
        ...
        public static void ToString_DragonboxShortest(float value, string expected)
        {
        ...
        public static void ToString_DragonboxSignificantDigits(float value, string format, string expected)
        {
