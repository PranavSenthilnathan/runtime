...
namespace System.Tests
{
    public class DoubleTests
    {
        ...
        // Regression coverage for the Dragonbox-based shortest formatter that replaced Grisu3.
        ...
        public static void ToString_DragonboxShortest(double value, string expected)
        {
        ...
        // Bounded fixed/counting conversion (1..18 significant digits) ported from Go's ftoafixed.go,
        // plus values that exceed 18 significant digits and therefore fall back to Dragon4.
        [Theory]
        ...
        public static void ToString_DragonboxSignificantDigits(double value, string format, string expected)
        {
            Assert.Equal(expected, value.ToString(format, CultureInfo.InvariantCulture));
        }

        [Fact]
        public static void ToString_DragonboxSubnormalBoundaries()
        {
        ...
        [Fact]
        public static void ToString_DragonboxRoundtrips()
        {
            CultureInfo inv = CultureInfo.InvariantCulture;
